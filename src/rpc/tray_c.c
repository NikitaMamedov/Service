...
static const RPC_CLIENT_INTERFACE TrayServiceRPC___RpcClientInterface =
    {
...
RPC_IF_HANDLE TrayServiceRPC_v1_0_c_ifspec = (RPC_IF_HANDLE)& TrayServiceRPC___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE TrayServiceRPC__MIDL_AutoBindHandle;
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayServiceRPC_StubDesc,
    ...
    /* [in] */ handle_t IDL_handle)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayServiceRPC_StubDesc,
                  (PFORMAT_STRING) &tray__MIDL_ProcFormatString.Format[30],
                  IDL_handle);
...
static const MIDL_STUB_DESC TrayServiceRPC_StubDesc = 
    {
    (void *)& TrayServiceRPC___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &TrayServiceRPC__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
